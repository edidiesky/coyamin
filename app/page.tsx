...
//           <CardTitle className="text-2xl font-bold text-center">AI Investment Copilot</CardTitle>
...
export default function SignInPage() {
  return (
    <div className="w-full flex h-[100vh] min-h-[100vh] items-center justify-center">
